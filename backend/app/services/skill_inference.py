...
class SkillInferenceEngine:
    ...
    def __init__(self):
        ...
        self.skill_taxonomy = {
            "Technical": {
                "Programming": [
                    ...
                    "Rust", "PHP", "Swift", "Kotlin", "R", "MATLAB", "Scala"
                ],
                "Data & Analytics": [
                    "SQL", "Data Analysis", "Excel", "Tableau", "Power BI", "Looker",
                    "Data Visualization", "Statistical Analysis", "A/B Testing",
                    "Google Analytics", "ETL", "Data Modeling"
                ],
                "AI & Machine Learning": [
                    "Machine Learning", "Deep Learning", "NLP", "Computer Vision",
                    "TensorFlow", "PyTorch", "Scikit-learn", "Neural Networks",
                    "AI Ethics", "Prompt Engineering", "LLMs"
                ],
                "Cloud & Infrastructure": [
                    "AWS", "Azure", "GCP", "Docker", "Kubernetes", "Terraform",
                    "CI/CD", "DevOps", "Linux", "Networking", "Security"
                ],
                "Web & Mobile": [
                    "React", "Angular", "Vue.js", "Node.js", "HTML/CSS", "REST APIs",
                    "GraphQL", "Mobile Development", "iOS", "Android", "Flutter"
                ],
                "Database": [
            ...
            "Business": {
                "Management": [
                    ...
                    "Program Management", "Change Management", "Resource Planning",
                    "Risk Management", "Vendor Management"
                ],
                "Strategy": [
                    "Business Strategy", "Market Analysis", "Strategic Planning",
                    "Competitive Analysis", "Business Development", "Roadmap Planning",
                    "OKRs", "KPI Management"
                ],
                "Finance": [
                    "Financial Analysis", "Budgeting", "Forecasting", "Accounting",
                    "Financial Modeling", "P&L Management", "Cost Analysis",
                    "Investment Analysis"
                ],
                "Sales & Marketing": [
                    "Sales", "Business Development", "Negotiation", "CRM", "Marketing",
                ...
                "Product": [
                    ...
                    "Product Analytics", "Roadmap Planning", "Pricing Strategy",
                    "Go-to-Market Strategy"
                ]
            },
            "Soft Skills": {
                "Communication": [
                    "Presentation", "Technical Writing", "Stakeholder Management",
                    "Executive Communication", "Public Speaking", "Documentation",
                    "Cross-functional Collaboration"
                ],
                "Problem Solving": [
                    "Critical Thinking", "Analytical Thinking", "Innovation",
                    "Creative Problem Solving", "Systems Thinking", "Debugging",
                    "Root Cause Analysis"
                ],
                "Interpersonal": [
                    "Collaboration", "Mentoring", "Conflict Resolution", "Empathy",
                    "Active Listening", "Emotional Intelligence", "Team Building",
                    "Feedback Delivery"
                ],
                "Leadership": [
                    "People Management", "Coaching", "Influence", "Decision Making",
                    "Vision Setting", "Delegation", "Performance Management"
                ]
            },
            "Domain Expertise": {
                "Industries": [
                    "Healthcare", "Finance", "E-commerce", "SaaS", "Education",
                    "Manufacturing", "Retail", "Telecommunications", "Energy"
                ],
                "Specialized": [
                    "Compliance", "Legal", "HR", "Operations", "Supply Chain",
                    "Quality Assurance", "Customer Success", "UX Design"
                ]
            }
        }
        ...
        self.skill_relationships = {
            # Programming
            "Python": [
                ("Data Analysis", 0.85), ("Machine Learning", 0.80),
                ("Backend Development", 0.75), ("Automation", 0.70),
                ("Data Engineering", 0.75), ("API Development", 0.70)
            ],
            "JavaScript": [
                ("React", 0.85), ("Node.js", 0.80), ("TypeScript", 0.75),
                ("Frontend Development", 0.90), ("Full-Stack Development", 0.70)
            ],
            "SQL": [
                ("Data Analysis", 0.90), ("Database Design", 0.85),
                ("Business Intelligence", 0.75), ("Data Engineering", 0.70),
                ("ETL", 0.65)
            ],
            
            # Management
            "Project Management": [
                ("Agile", 0.90), ("Team Leadership", 0.85), ("Scrum", 0.80),
                ("Product Management", 0.70), ("Program Management", 0.75),
                ("Resource Planning", 0.80)
            ],
            "Agile": [
                ("Scrum", 0.95), ("Project Management", 0.85),
                ("Team Leadership", 0.75), ("Change Management", 0.70)
            ],
            
            # Data & Analytics
            "Data Analysis": [
                ("SQL", 0.85), ("Excel", 0.80), ("Tableau", 0.75),
                ("Business Intelligence", 0.80), ("Data Visualization", 0.85),
                ("Statistical Analysis", 0.70)
            ],
            "Machine Learning": [
                ("Python", 0.90), ("Data Analysis", 0.85), ("Deep Learning", 0.75),
                ("TensorFlow", 0.70), ("Statistical Analysis", 0.75)
            ],
            
            # Business
            "Business Strategy": [
                ("Market Analysis", 0.85), ("Strategic Planning", 0.90),
                ("Competitive Analysis", 0.80), ("Business Development", 0.75)
            ],
            "Product Management": [
                ("Product Strategy", 0.85), ("User Research", 0.80),
                ("Agile", 0.75), ("Data Analysis", 0.70), ("Roadmap Planning", 0.85)
            ],
    ...
    async def infer_adjacent_skills(
        ...
        hidden_skills = await self._infer_hidden_skills(
            current_skills, job_title, years_experience
        )
        
        # Step 4: Identify skill gaps for high-growth roles
        skill_gaps = await self._identify_skill_gaps(
            current_skills, adjacent_skills, job_title
        )
            ...
            for category, subcategories in self.skill_taxonomy.items():
                for subcat, skill_list in subcategories.items():
                    ...
                    for taxonomy_skill in skill_list:
                        if (skill_lower == taxonomy_skill.lower() or 
                            skill_lower in taxonomy_skill.lower() or
                            taxonomy_skill.lower() in skill_lower):
    ...
    def _find_adjacent_skills(self, current_skills: List[str]) -> List[Dict[str, Any]]:
        ...
        for skill in current_skills:
            ...
            for rel_skill, relationships in self.skill_relationships.items():
                if (skill.lower() == rel_skill.lower() or 
                    skill.lower() in rel_skill.lower() or
                    rel_skill.lower() in skill.lower()):
...
"""
        ...
        try:
            ...
            hidden_skills = [
                s for s in hidden_skills 
                if s.lower() not in current_skills_lower
            ]
...
async def enhance_analysis_with_skills(
    ...
    skill_insights = await engine.infer_adjacent_skills(
        current_skills, 
        job_title,
        years_experience
    )
