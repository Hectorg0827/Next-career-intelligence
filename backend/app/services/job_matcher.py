...
class JobMatcher:
    ...
    async def calculate_match_score(
        ...
        try:
            ...
            return {
                ...
                'why_matched': await self._generate_why_matched(
                    overall_score, match_highlights, skill_gaps
                )
            }
    ...
    async def _calculate_skill_fit(
        self,
        user_profile: Dict[str, Any],
        job: Dict[str, Any]
    ) -> float:
    ...
    async def _calculate_trajectory_fit(
        self,
        user_profile: Dict[str, Any],
        job: Dict[str, Any]
    ) -> float:
    ...
    async def _generate_why_matched(
        self,
        overall_score: float,
        highlights: List[str],
        gaps: List[str]
    ...
    async def _estimate_job_risk(self, job: Dict[str, Any]) -> float:
        ...
        very_high_risk_keywords = [
            'data entry', 'clerk', 'operator', 'transcription',
            'routine', 'repetitive', 'administrative assistant',
            'call center', 'telemarketer', 'cashier'
        ]
        ...
        high_risk_keywords = [
            ...
            'specialist', 'technical support', 'quality assurance',
            'bookkeeping', 'payroll'
        ]
        ...
        medium_risk_keywords = [
            'developer', 'engineer', 'designer', 'researcher',
            'consultant', 'account manager', 'project manager'
        ]
        ...
        low_risk_keywords = [
            ...
            'sales', 'client success', 'relationship manager',
            'therapist', 'nurse', 'teacher', 'coach'
        ]
        ...
        very_low_risk_keywords = [
            ...
            'executive', 'vp of', 'svp', 'president',
            'artist', 'musician', 'psychiatrist'
        ]
        ...
        human_keywords = [
            'client', 'customer', 'team', 'collaboration',
            'leadership', 'management', 'presentation', 'communication'
        ]
        ...
        tech_keywords = [
            'architecture', 'design', 'strategy', 'research',
