...
class AIAnalyzerService:
    ...
    async def analyze_displacement_risk(
        self, job_title: str, skills: List[str], location: str, occupation_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        prompt = self._build_risk_analysis_prompt(job_title, skills, location, occupation_data)
    ...
    async def analyze_compatibility(self, current_skills: List[str], occupation_data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _build_compatibility_prompt(self, skills: List[str], occupation_data: Dict[str, Any]) -> str:
    ...
    def _get_fallback_compatibility(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "human_advantage_factors": ["Critical thinking", "Interpersonal communication"],
            "transition_pathways": [
                {
