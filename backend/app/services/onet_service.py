...
class ONetService:
    ...
    async def get_occupation_data(self, job_title: str) -> Dict[str, Any]:
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.get(
                    f"{self.base_url}/online/occupations/{onet_code}", headers=self.headers, timeout=10.0
                )
    ...
    def _calculate_automation_indicators(self, occupation_data: Dict) -> Dict[str, Any]:
        ...
        return {"routine_task_intensity": "medium", "cognitive_complexity": "high", "social_interaction": "medium"}
    ...
    def _get_mock_occupation_data(self, job_title: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "skills": ["Critical Thinking", "Active Listening", "Communication", "Problem Solving"],
            "abilities": ["Oral Comprehension", "Written Comprehension", "Deductive Reasoning"],
