...
FIRST_NAMES = [
    ...
    "Abigail", "Sebastian", "Emily", "Jack", "Elizabeth", "Michael", "Sofia", "Daniel", "Avery", "Matthew",
    "Ella", "Joseph", "Scarlett", "David", "Grace", "Logan", "Chloe", "Jackson", "Victoria", "Samuel",
    "Riley", "Owen", "Aria", "Wyatt", "Lily", "John", "Aubrey", "Carter", "Zoey", "Dylan"
]
...
JOB_TITLES = [
    ...
    "Full Stack Developer", "Frontend Developer", "Backend Developer", "ML Engineer", "Cloud Architect",
    "Business Analyst", "Project Manager", "Marketing Manager", "Sales Executive", "HR Manager",
    "Financial Analyst", "Accountant", "Operations Manager", "Customer Success Manager", "Content Writer",
    "Graphic Designer", "Mobile Developer", "QA Engineer", "Security Engineer", "Database Administrator"
]
...
LOCATIONS = [
    ...
    "Remote", "Miami, FL", "Dallas, TX", "Phoenix, AZ", "San Diego, CA"
]
