...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(50), nullable=False, server_default="applied"
        ),  # applied, rejected, interview, offered
    ...
    op.create_table(
        ...
        sa.Column(
            "alert_frequency", sa.String(50), nullable=False, server_default="daily"
