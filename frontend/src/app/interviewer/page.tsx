...
export default function InterviewerLandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-silver-light py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <Link href="/interviewer/sessions">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow cursor-pointer border-2 border-transparent hover:border-royal-blue">
              ...
              <div className="flex items-center text-royal-blue font-medium">
                View History
                <svg className="ml-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-silver-light rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-gold-primary">A</span>
              </div>
