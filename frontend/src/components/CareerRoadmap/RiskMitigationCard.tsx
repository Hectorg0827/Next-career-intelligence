  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 border border-gray-200 dark:border-gray-700 h-full">
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div className="space-y-2">
            {mitigation.pivot_options.map((option, index) => (
              <div
                key={index}
                className="p-3 rounded-lg bg-silver-soft dark:bg-royal-navy/20 border border-silver-soft dark:border-gold-accent text-sm text-purple-800 dark:text-silver-soft flex items-start space-x-2"
              >
        ...
        {/* Why These Skills */}
        <div className="p-4 rounded-xl bg-gradient-to-r from-blue-50 to-silver-soft dark:from-blue-900/20 dark:to-royal-navy/20 border border-blue-200 dark:border-blue-700">
